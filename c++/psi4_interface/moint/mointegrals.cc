...
namespace psi{ namespace moint{

extern "C" PSI_API
int read_options(std::string name, Options &options)
{
    if (name == "MOINT" || options.read_globals()) {
...
extern "C" PSI_API
SharedWavefunction moint(SharedWavefunction ref_wfn, Options& options)
{
    /*
    ...
    //                       C1 C2 C3 C4
    std::cout << mints.mo_eri(Ca, Ca, Ca, Ca)->get(0,0) << "\n";
